...
run_adamw() {
  ...
  eval_stage \
    "${out_root}/sft_seq2_coding_qwen3b_instruct_adamw" \
    "${res_root}" \
    "${log_root}" \
    "stage_a" \
    "bcb_hard_adamw"
  ...
  eval_stage \
    "${out_root}/sft_seq2_math_qwen3b_instruct_adamw_from_coding" \
    "${res_root}" \
    "${log_root}" \
    "stage_b" \
  ...
  eval_stage \
    "${out_root}/sft_seq2_medical_qwen3b_instruct_adamw_from_coding_math" \
    "${res_root}" \
    "${log_root}" \
    "stage_c" \
