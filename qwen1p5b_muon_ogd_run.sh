...
run_muon() {
  ...
  eval_stage \
    "${out_root}/sft_seq2_coding_qwen1.5b_instruct_muon_ogd" \
    "${res_root}" \
    "${log_root}" \
    "stage_a" \
    "bcb_hard_muon"
  ...
  eval_stage \
    "${out_root}/sft_seq2_math_qwen1.5b_instruct_muon_ogd_from_coding" \
    "${res_root}" \
    "${log_root}" \
    "stage_b" \
  ...
  eval_stage \
    "${out_root}/sft_seq2_medical_qwen1.5b_instruct_muon_ogd_from_coding_math" \
    "${res_root}" \
    "${log_root}" \
    "stage_c" \
    "bcb_hard_muon_final"
