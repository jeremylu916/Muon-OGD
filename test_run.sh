...
# Ablation runner:
# 1) Coding robustness ablation (Stage A):
#    - --val_ratio 0
#    - --no-normalize_targets
#    - lower LR + more epochs
#    - report final_valid + pass@1
# 2) Medical dataset alignment ablation (Stage C):
#    - train on FreedomIntelligence/medical-o1-verifiable-problem (default config)
#    - compare medical score vs current Stage C result

BASE_MODEL="Qwen/Qwen2.5-1.5B"
STAGE_B_ADAMW_MODEL="outputs/sft_seq2_math_qwen1.5b_adamw_from_coding"

CODING_ABLATION_MODEL="outputs/sft_seq2_coding_qwen1.5b_adamw_ablation"
CODING_BCB_OUTDIR="results_seq2/ablation/stage_a_coding_robust/bcb_complete_full"
CODING_TRAIN_LOG="logs_seq2/ablation/train_coding_adamw_ablation.log"
CODING_EVAL_LOG="logs_seq2/ablation/eval_bcb_coding_adamw_ablation.log"

MED_ALIGN_MODEL="outputs/sft_seq2_medical_qwen1.5b_adamw_from_coding_math_aligned"
MED_ALIGN_TRAIN_LOG="logs_seq2/ablation/train_medical_adamw_aligned.log"
MED_ALIGN_EVAL_LOG="logs_seq2/ablation/eval_medical_adamw_aligned.log"
MED_ALIGN_OUT="results_seq2/ablation/stage_c_medical_align/medical_adamw_aligned.json"
...
mkdir -p \
  logs_seq2/ablation \
  results_seq2/ablation/stage_a_coding_robust \
  results_seq2/ablation/stage_c_medical_align \
  outputs

echo "==== [1/4] Coding robustness ablation: train Stage A model ===="
...
echo "==== [2/4] Coding robustness ablation: eval Stage A coding ===="
...
echo "==== [3/4] Medical dataset alignment ablation: train Stage C model ===="
...
echo "==== [4/4] Medical dataset alignment ablation: eval Stage C medical ===="
...
coding_eval_log = "logs_seq2/ablation/eval_bcb_coding_adamw_ablation.log"
coding_pass_file = "results_seq2/ablation/stage_a_coding_robust/bcb_complete_full/pass_at_k.json"
med_align_file = "results_seq2/ablation/stage_c_medical_align/medical_adamw_aligned.json"
current_candidates = [
...
print("Coding robustness ablation:")
...
print()
print("Medical dataset alignment ablation:")
...
if current_med_acc is not None:
    delta = aligned_med_acc - current_med_acc if aligned_med_acc is not None else None
    if delta is None:
